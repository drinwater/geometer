...
from geometer2.point import LineTensor, Point, Subspace, infty_hyperplane
from geometer2.utils import inv, matmul, outer
...
if TYPE_CHECKING:
    ...
    from geometer2.curve import Conic
    from geometer2.utils.typing import NumericalScalarType, TensorParameters
