...
from geometer2.curve import absolute_conic
from geometer2.exceptions import NotCollinear, NotConcurrent
...
from geometer2.utils import det, matvec, orth

if TYPE_CHECKING:
    from geometer2.shapes import PolytopeTensor
...
def dist(
    ...
    from geometer2.shapes import PolygonTensor, Polyhedron, SegmentTensor  # noqa: PLC0415
