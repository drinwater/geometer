...
if TYPE_CHECKING:
    ...
    from geometer2.utils.typing import NDArrayParameters, NumericalScalar, TensorParameters

from geometer2.base import (
    EQ_TOL_ABS,
    EQ_TOL_REL,
    BoundTensor,
    LeviCivitaTensor,
...
from geometer2.exceptions import GeometryException, LinearDependenceError, NotCoplanar
from geometer2.utils import is_multiple, is_numerical_scalar, matmul, matvec, null_space
...
class SubspaceTensor(ProjectiveTensor, ABC):
    ...
    def __add__(self, other: Tensor | npt.ArrayLike) -> Tensor:
        ...
        from geometer2.transformation import translation  # noqa: PLC0415
...
class PlaneTensor(SubspaceTensor):
    ...
    def mirror(self, pt: PointTensor) -> PointTensor:
        ...
        from geometer2.curve import absolute_conic  # noqa: PLC0415
